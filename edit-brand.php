...
// acelasi cod ca si la actualizarea parolei	
   if(isset($_POST['submit'])) {
       $brand=$_POST['brand'];
       $id=$_GET['id'];
$query="update marci set nume_marca='$brand' where nume_marca='$brand'";
if(performQuery($query)){
            echo "<script>alert('Edit request succesfully!!!')</script>";
          }else{
...
<?php	
   $id=$_GET['id'];
   $query="select * from marci where id='$id'";
...
?>
											...
											<div class="form-group">
												...
												<div class="col-sm-8">
													<input type="text" class="form-control" value="<?php echo $row['nume_marca'];?>" name="brand" id="brand" required>
												</div>
											</div>
