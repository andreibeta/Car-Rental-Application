			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Manage Registration Requests</h2>

						<!-- Zero Configuration Table -->
						<div class="panel panel-default">
							<div class="panel-heading">Registrations Info</div>
							<div class="panel-body">
								...
								<table id="zct" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
									...
									<?php 
$query="SELECT * FROM registration_request;";
if(count(getAll($query))>0){
    foreach(getAll($query) as $row){
	 			?>	
										...
										<td><a type="button" class="btn btn-success btn-xs" href="accept_registration_request.php?id=<?php echo $row['id'];?>" 
										        onclick="return confirm('Do you really want to Confirm this booking')"> Accept</a> 
										<a type="button" class="btn btn-danger btn-xs" href="reject_registration_request.php?id=<?php echo $row['id'];?>" 
												onclick="return confirm('Do you really want to Cancel this Booking')"> Reject</a></td>
