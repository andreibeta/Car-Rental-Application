...
<?php 
      ...
      $query = "SELECT id from vehicle_table";
	  performQuery($query);
...
<?php 
$query = "SELECT vehicle_table.*,marci.nume_marca,marci.id as bid  from vehicle_table join marci on marci.id=vehicle_table.vehicle_brand order by id desc";
performQuery($query);
$cnt=1;
...
if(count(getAll($query))>0){
    foreach(getAll($query) as $row){ ?>
              ...
              <li class="gray-bg">
                <div class="recent_post_img"> <a href="vehicle-specification.php?vhid=<?php echo $row['id'];?>"><img src="assets/images/<?php echo $row['image1'];?>" alt="image"></a> </div>
                <div class="recent_post_title"> <a href="vehical-specification.php?vhid=<?php echo $row['id'];?>"><?php echo $row['nume_marca'];?> , <?php echo $row['vehicle_type'];?></a>
