...
move_uploaded_file($_FILES["img2"]["tmp_name"],"assets/images/".$_FILES["img2"]["name"]);
move_uploaded_file($_FILES["img3"]["tmp_name"],"assets/images/".$_FILES["img3"]["name"]);
move_uploaded_file($_FILES["img4"]["tmp_name"],"assets/images/".$_FILES["img4"]["name"]);


$query="INSERT INTO vehicle_table(vehicle_type,vehicle_brand,vehicle_overview,price,fuel_type,model_year,
seats,image1,image2,image3,image4,air_conditioner,abs,brake_assist,airbags,navigation,crash_sensor,leather_seats) 
VALUES('$vehicletitle','$brand','$vehicleoverview','$priceperday','$fueltype','$modelyear','$seatingcapacity',
'$vimage1','$vimage2','$vimage3','$vimage4','$airconditioner','$antilockbrakingsys','$brakeassist','$airbags',
'$navigation','$crashcensor','$leatherseats')";
 if(performQuery($query)){
	 echo "<script>alert('Car insertion has been accepted!!!')</script>";
 }else{
...
<label class="col-sm-2 control-label">Crash Sensor<span style="color:red">*</span></label>
<div class="col-sm-2">
<select class="form-control form-control-sm" name="leatherseats" required>
